...
parser.add_argument("--data_dir", type=str, default='/remote-home/pengyichen/RULER_pyc/result_base/llama3-8b/synthetic/131072/data')
...
def main():
    ...
    keys_to_keep = ['niah_multikey_1','niah_multikey_2','niah_multikey_3','niah_single_1','niah_single_2','niah_single_3']
    # keys_to_keep = ['cwe','fwe','niah_multiquery','niah_multivalue','qa_1','qa_2','vt']
    
    TASKS = {k: TASKS[k] for k in keys_to_keep if k in TASKS}
    ...
    for task, config in TASKS.items():
        ...
        task_score, task_nulls, predicts, indices = run_evaluation_per_task(
            predictions_file=os.path.join('/remote-home/pengyichen/RULER_pyc/result_vllm_first/llama3-8b/synthetic/131072/pred/2048-16', f'{task}.jsonl'),
            task_config=config,
        )
        eval_results[task] = {
            'score': task_score,
